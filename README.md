# 路皓智能记账 (Luhao Ledger / Smart Ledger) 📱
...
专为餐饮与多人经营场景打造的智能记账 Android 手机应用。支持微信群聊记录/手写小票/转账截图 OCR 识别提取、多模态 AI 智能人名与别名理解、单日总收入与各成员支出自动核算、月度分类报表、累计总览看板与每日特殊情况备注。
...
1. **📸 智能识图与免费 OCR 提取**：
   ...
   - 内置免费 OCR 图像文字提取通道与多模态 Vision 识别。
2. **🤖 AI 智能理解与称谓别名映射**：
